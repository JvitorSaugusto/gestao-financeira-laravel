...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-gold mb-0">Editar Lançamento #{{ $transaction->id }}</h3>
            ...
            <form action="{{ route('transactions.update', $transaction->id) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description', $transaction->description) }}">
                        @error('description') 
